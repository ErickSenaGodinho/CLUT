...
#define ClutRepeatedTest(name, value, failureThreshold)                                                                                                                                                                                                            \
...
#define REPEATED_TEST(name, value) ClutRepeatedTest(name, value, SIZE_MAX)
#define REPEATED_TEST_WITH_THRESHOLD(name, value, failureThreshold) ClutRepeatedTest(name, value, failureThreshold)
